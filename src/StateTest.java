...
public class StateTest
{
    ...
    public void testConstructor()
    {
        ...
        assertEquals(
                testFieldMapper.extractPointND(testValues.split(","), "left_shoulder").getValue("z").getDoubleValue(),
                testState.getPoint("left_shoulder").getValue("z").getDoubleValue(), 0.001);
    }
    ...
    public void testGetPoint()
    {
        ...
        State testState = new State(null, testFieldMapper, testValues);
        assertEquals(
                testFieldMapper.extractPointND(testValues.split(","), "right_wrist").getValue("x").getDoubleValue(),
                testState.getPoint("right_wrist").getValue("x").getDoubleValue(), 0.001);
    }
    ...
    public void testGetValue()
    {
        ...
        FieldMapper testFieldMapper = new FieldMapper(testColumnHeaders.split(","));
        State testState = new State(null, testFieldMapper, testValues);
        assertEquals(new GeneralValue(2.11).getDoubleValue(), testState.getValue("left_shoulder", "z").getDoubleValue(),
                0.001);
    }
