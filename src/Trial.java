...
public class Trial extends MultipleItemAbstract
{
    ...
    /**
     * Trial constructor that takes in directory and ID and access and read data
     * from a file.
     * 
     * @param infant
     *            to which the trial belongs to.
     * @param directory
     *            String representing the directory containing the data files.
     * @param infantID
     *            String representing the infant ID.
     * @param week
     *            integer week for the data file.
     * 
     * @throws IOException
    ...
    public String toString()
    {
        ...
        // If week is less than 10 meaning one digit then return with a 0 in front of
        // the week.
        if (week < 10)
        {
