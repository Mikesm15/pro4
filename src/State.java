...
public class State extends SingleItemAbstract implements Iterable<String>
{
     ...
     * 
     * @param trial
     *            as input to which State it belongs to.
     * @param fieldMapper
     *            will tell us how to create fields from the data.
     * @param values
     *            describes the associated State.
     */
    ...
    /**
     * This returns the PointND object corresponding to the field name. If field is
     * not a part of the State then it is null.
     * 
     * @param fieldName
     *            is this like left_wrist.
     ...
     * 
     * @param fieldName
     *            this is like left_wrist.
     * @param subFieldName
     *            this is like x, y, and z of left_wrist.
     * @return GeneralValue object.
     */
    public GeneralValue getValue(String fieldName, String subFieldName)
    {
        // If it contains this field then returns the GeneralValue which corresponds
        // with it.
        if (variables.containsKey(fieldName))
        {
    ...
    /**
     * Iterators through the variables treeMap to get the field names. It overrides
     * the method defined in Iterator interface.
     * 
     * @return loopThrough
     */
    @Override
