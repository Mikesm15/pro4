...
/**
 * PointND will represent a single value with subfields. For example having
 * leftWrist as the value and x, y ,z as the subfields.
 * 
...
{
    /**
     * Map that takes in string field and describe it to the corresponding general
     * value. Remember that TreeMap orders by key.
     */
     ...
     *            is the field name.
     * @param value
     *            is the corresponding General value.
     */
    ...
    /**
     * Input the string and it will return the corresponding value stored in the
     * map.
     * 
     * @param subFieldName
     *            this is like x, y, and z of the left_wrist.
    ...
    /**
     * Gets the string iterator over all field names. It overrides the method
