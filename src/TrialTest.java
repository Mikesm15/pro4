...
public class TrialTest
{
     ...
     * 
     * @throws IOException
     *             Throws if it cannot grab data file.
     */
    @Test
    ...
    /**
     * Tests the getMaxState method. Also tests the getMaxState method within
     * MultipleItemAbstract.
     * 
     * @throws IOException
     *             Throws if file cannot be obtained.
     */
    @Test
    public void testGetMaxState() throws IOException
    {
        ...
        Trial testTrial = new Trial(null, "mydata", "k3", 1);
        // Checks if a State object containing the value corresponding to field and
        // subfield is returned.
        assertEquals(0.238, testState.getMaxState("right_wrist", "x").getValue("right_wrist", "x").getDoubleValue(),
                0.001);
        // Checks if the correct maximum value is obtained for the field and subfield.
        assertEquals(0.214482,
                testTrial.getMaxState("right_wrist", "x").getPoint("right_wrist").getValue("x").getDoubleValue(),
                0.001);
    }

    /**
     * Tests the getMinState method. Also tests the getMinState method within
     * MultipleItemAbstract.
     * 
     * @throws IOException
     *             Throws if file cannot be obtained.
    ...
    public void testGetMinState() throws IOException
    {
        ...
        // Checks if a State object containing the value corresponding to field and
        // subfield is returned.
        assertEquals(2.11, testState.getMinState("left_shoulder", "z").getValue("left_shoulder", "z").getDoubleValue(),
                0.001);
        // Checks if the correct minimum value is obtained for the field and subfield.
        assertEquals(0.212279,
                testTrial.getMinState("right_wrist", "x").getPoint("right_wrist").getValue("x").getDoubleValue(),
                0.001);
    }

    /**
     * Tests the getAverageValue method. Also tests the getAverageValue method
     * within MultipleItemAbstract.
     * 
     * @throws IOException
     *             Throws if file cannot be obtained.
     */
    ...
    public void testGetAverageValue() throws IOException
    {
        ...
        assertEquals(0.21329163636363635, testTrial.getAverageValue("right_wrist", "x").getDoubleValue(), 0.001);
    }
