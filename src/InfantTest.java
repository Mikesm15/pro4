...
public class InfantTest
{
    ...
    public void testFirstConstructor() throws IOException
    {
        ...
        Assert.assertEquals(0.248297, testInfant.getItem(0).getItem(0).getValue("left_wrist", "x").getDoubleValue(),
                0.001);
        // Test it exists.
    ...
    {
        Infant testInfant = new Infant("mydata", "k3");
        // Since the final output of trials & weeks are unknown we are testing that
        // getSize can return.
    ...
    public void testGetItem() throws IOException
    {
        ...
        Assert.assertEquals(0.291787, testInfant.getItem(0).getItem(0).getValue("left_elbow", "x").getDoubleValue(),
                0.001);
