 ...
 * @version 2017-10-23
 * 
 *          MultipleItemAbstract Class - The heavy calculating is done within
 *          this class for the Max/Min/Avg values. This class extends Single
 *          Item and also is able to obtain the size of the array and also
 *          obtain certain indexes.
 */
public abstract class MultipleItemAbstract extends SingleItemAbstract
{
    ...
    /**
     * @param index
     *            The specific location that the user wants to pull from the
     *            arrayList.
    ...
    /**
     * This method cycles through all the values of the given field and subfield and
     * then calculates and returns the state that contains the maximum value.
     * 
     * @param fieldName
     *            The field we are looking at (ie. right_wrist).
     * @param subFieldName
     *            The subfield of the field (ie. X/Y/Z).
     * @return Returns the State in which the max resides for the field and
     *         subfield.
     */
    public State getMaxState(String fieldName, String subFieldName)
    {
        // Sets the maximum value to negative infinity so that any value great can take
        // its place.
    ...
    /**
     * This method cycles through all the values of the given field and subfield and
     * then calculates and returns the state that contains the minimum value.
     * 
     * @param fieldName
     *            The field we are looking at (ie. right_wrist).
     * @param subFieldName
     *            The subfield of the field (ie. X/Y/Z).
     * @return Returns the State in which the min resides for the field and
     *         subfield.
     */
    public State getMinState(String fieldName, String subFieldName)
    {
        // Sets the minimum value to positive infinity so that any value less can take
        // its place.
    ...
    /**
     * Obtains the average value for the field and subfield the user is looking to
     * obtain by adding all the values together and then dividing it to obtain the
     * average value.
     * 
     * @param fieldName
     *            The field we are looking at (ie. right_wrist).
     * @param subFieldName
     *            The subfield of the field (ie. X/Y/Z).
     * @return Returns the GeneralValue for the average value for the field and
     *         subfield.
     */
