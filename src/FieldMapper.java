...
public class FieldMapper implements Iterable<String>
{
    ...
    /**
     * Here we take in a list of individual columns. Column names are related to
     * field and subfield. The constructor will create the entire data structures.
     * 
     * @param columnNames
     *            is the columns in the file.
     */
     ...
     * 
     * @param fieldName
     *            is for example left_wrist_x, fieldMapper would split that and
     *            left_wrist is the field.
    ...
    /**
     * Gets the string values and field name from PointND. This method constructs
     * PointND object for the type field it received.
     * 
     * @param stringValues
     *            this is a list of values extracted from the files.
     * @param fieldName
     *            is for example left_wrist_x and it is split then left_wrist is the
     *            fieldName.
     * @return PointND this is represented as one value of left_wrist with x, y, and
     *         z values.
     */
    public PointND extractPointND(String[] stringValues, String fieldName)
    {
        ...
        // Adds the subfield and the corresponding value from the stringValues by
    ...
    /**
     * Iterators through the fieldMap Map all field names. It overrides the method
     * defined in Iterator interface.
     * 
     * @return loopThrough
     */
    @Override
