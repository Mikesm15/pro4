...
public class Infant extends MultipleItemAbstract implements Iterable<Trial>
{
    ...
    /**
     * Default constructor takes in directory and infantID to create multiple trials
     * to compute and display statistics.
     * 
     * @param directory
     *            where the data came from.
     * @param infantID
     *            so we know which infant is which.
     * @throws IOException
     *             xx
     */
    ...
    /**
     * Overloaded constructor. This constructor takes in an existing infant and an
     * array of indices. The new infant will have the same infant ID but will have
     * the subset of the original infant's trials. The subset is defined by the
     * indices. Any illegal indices are ignored.
     * 
     * @param infant
     *            is the existing infant.
     * @param indices
